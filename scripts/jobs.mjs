 ...
 *   node scripts/jobs.mjs day_close|alerts_eval|anchor_reminder [YYYY-MM-DD]
 *
 * תזמון (Asia/Jerusalem) לפי חלק ג': day_close 06:30 · alerts_eval 06:45 · anchor_reminder 08:30.
...
if (!name) { console.error('שימוש: node scripts/jobs.mjs <day_close|alerts_eval|anchor_reminder> [YYYY-MM-DD]'); process.exit(1) }
