 ...
 *   node scripts/jobs.mjs day_close|alerts_eval|anchor_reminder|daily_summary [YYYY-MM-DD]
 *
...
if (!name) { console.error('שימוש: node scripts/jobs.mjs <day_close|alerts_eval|anchor_reminder|daily_summary> [YYYY-MM-DD]'); process.exit(1) }
